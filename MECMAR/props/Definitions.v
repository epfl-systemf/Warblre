...
Module Definitions.
  ...
  Definition characterClass_successful_state `{CharacterInstance} input endIndex captures (dir: Direction) := input [@ step{dir} endIndex $ captures ].

  Module RepeatMatcher.
    Definition matcher `{CharacterInstance} (m: Matcher) (min: non_neg_integer) (max: non_neg_integer_or_inf) 
