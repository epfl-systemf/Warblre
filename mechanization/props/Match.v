...
From Warblre Require Import List Tactics Retrieve Specialize Focus Result Base Patterns Node StaticSemantics Notation Semantics Definitions EarlyErrors Compile RegExpRecord.
...
Module Correctness.
  ...
  *)
  ...
  Inductive directionalProgress {Character} `{ep: CharacterInstance Character}: Direction -> MatchState -> MatchState -> Prop :=
  ...
  Inductive progress {Character} `{ep: CharacterInstance Character}: Direction -> MatchState -> MatchResult -> Prop :=
  ...
  Definition IteratorOn {Character} `{ep: CharacterInstance Character} (str: list Character) (i: Z) := (0 <= i <= Z.of_nat (length str))%Z.
  ...
  Module MatchState. Section main.
    ...
    Definition init {Character} `{ep: CharacterInstance Character} (rer: RegExpRecord) (str: list Character) (i: nat) := (match_state str (Z.of_nat i) (List.repeat None (RegExpRecord.capturingGroupsCount rer))).

    Lemma valid_init {Character} `{ep: CharacterInstance Character}: forall rer str i, (i <= length str) -> Valid str rer (init rer str i).
    Proof.
  ...
  Lemma initialState_validity {Character} `{ep: CharacterInstance Character}: forall input i rer,
    i <= (length input) ->
  ...
  Theorem monotony {Character} `{ep: CharacterInstance Character}: forall r rer input i m,
  ...
  Theorem monotony' {Character} `{ep: CharacterInstance Character}: forall r rer input i m z,
    EarlyErrors.Pass_Regex r nil ->
    countLeftCapturingParensWithin r nil = RegExpRecord.capturingGroupsCount rer ->
    compilePattern r rer = Success m ->
  ...
  Theorem termination {Character} `{ep: CharacterInstance Character}: forall r rer input i m,
    EarlyErrors.Pass_Regex r nil ->
    countLeftCapturingParensWithin r nil = RegExpRecord.capturingGroupsCount rer ->
    compilePattern r rer = Success m ->
  ...
  Theorem no_failure {Character} `{ep: CharacterInstance Character}: forall r rer input i m,
    EarlyErrors.Pass_Regex r nil ->
    countLeftCapturingParensWithin r nil = RegExpRecord.capturingGroupsCount rer ->
    compilePattern r rer = Success m ->
    (i <= length input) ->
