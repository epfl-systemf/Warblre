...
Module EndToEnd.
  ...
  Definition regex_compile {Σ} `{ep: CharacterInstance Σ} (r: Regex) (rer: RegExpRecord)
  ...
  Definition regex_match {Σ} `{ep: CharacterInstance Σ} (r: Regex) (rer: RegExpRecord) (input: list Character) (start: non_neg_integer)
      (P0: countLeftCapturingParensWithin r nil = RegExpRecord.capturingGroupsCount rer)
      (P1: EarlyErrors.Pass_Regex r nil)
  ...
  Definition regex_end_to_end {Σ} `{ep: CharacterInstance Σ} (r: Regex) (rer: RegExpRecord) (input: list Character) (start: non_neg_integer)
      (P0: countLeftCapturingParensWithin r nil = RegExpRecord.capturingGroupsCount rer)
