...
Module Correctness.
  ...
  *)
  ...
  Inductive directionalProgress {Σ} `{ep: CharacterInstance Σ}: Direction -> MatchState -> MatchState -> Prop :=
  ...
  Inductive progress {Σ} `{ep: CharacterInstance Σ}: Direction -> MatchState -> MatchResult -> Prop :=
  ...
  Definition IteratorOn {Σ} `{ep: CharacterInstance Σ} (str: list Character) (i: Z) := (0 <= i <= Z.of_nat (length str))%Z.
  ...
  Module MatchState. Section main.
    ...
    Definition init {Σ} `{ep: CharacterInstance Σ} (rer: RegExpRecord) (str: list Character) (i: nat) := (match_state str (Z.of_nat i) (List.repeat None (RegExpRecord.capturingGroupsCount rer))).

    Lemma valid_init {Σ} `{ep: CharacterInstance Σ}: forall rer str i, (i <= length str) -> Valid str rer (init rer str i).
    Proof.
  ...
  Lemma initialState_validity {Σ} `{ep: CharacterInstance Σ}: forall input i rer,
    i <= (length input) ->
  ...
  Theorem monotony {Σ} `{ep: CharacterInstance Σ}: forall r rer input i m,
  ...
  Theorem monotony' {Σ} `{ep: CharacterInstance Σ}: forall r rer input i m z,
    EarlyErrors.Pass_Regex r nil ->
    countLeftCapturingParensWithin r nil = RegExpRecord.capturingGroupsCount rer ->
    compilePattern r rer = Success m ->
  ...
  Theorem termination {Σ} `{ep: CharacterInstance Σ}: forall r rer input i m,
    EarlyErrors.Pass_Regex r nil ->
    countLeftCapturingParensWithin r nil = RegExpRecord.capturingGroupsCount rer ->
    compilePattern r rer = Success m ->
  ...
  Theorem no_failure {Σ} `{ep: CharacterInstance Σ}: forall r rer input i m,
    EarlyErrors.Pass_Regex r nil ->
    countLeftCapturingParensWithin r nil = RegExpRecord.capturingGroupsCount rer ->
    compilePattern r rer = Success m ->
    (i <= length input) ->
