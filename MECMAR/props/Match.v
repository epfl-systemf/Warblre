...
Module Correctness.
  ...
  *)
  ...
  Module MatchState. Section main.
    ...
    Definition init `{CharacterInstance} (rer: RegExpRecord) (str: list Character) (i: nat) := (match_state str (Z.of_nat i) (List.repeat None (RegExpRecord.capturingGroupsCount rer))).
